...
public class BlockModelJsonGeneratorForMA extends BlockStateProvider {
    public BlockModelJsonGeneratorForMA(PackOutput output, ExistingFileHelper existingFileHelper) {
    ...
    public String getName() {
        return MysticalMoreCrops.NAME + " block model generator in mysticalagriculture folder";
    }
}
